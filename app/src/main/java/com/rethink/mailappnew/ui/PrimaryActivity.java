...
public class PrimaryActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dbManager = new DBManager(PrimaryActivity.this);
        sendButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if (queryEditText.getText().toString().equals("")) {
                    showDialog("Please type a query!!!");
                } else {

                    if (isNetworkAvailable()) {
                        data = queryEditText.getText().toString();
    ...
    private void getAccess() {
        if (!isGooglePlayServicesAvailable()) {
            ...
            Toast.makeText(PrimaryActivity.this, "No network connection", Toast.LENGTH_SHORT).show();
        }
    }
